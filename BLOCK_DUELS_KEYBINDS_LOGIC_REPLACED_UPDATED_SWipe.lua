...
;(function()
    ...
    -- BUTTON BACKGROUND IMAGE is also applied to the STEAL BAR.
    store["ButtonBackgroundImage"] = Instance.new("ImageLabel")
    store.ButtonBackgroundImage.Name = "ButtonBackgroundImage"
    store.ButtonBackgroundImage.ZIndex = 50
    store.ButtonBackgroundImage.Size = UDim2.new(1, 0, 1, 0)
    store.ButtonBackgroundImage.Position = UDim2.new(0, 0, 0, 0)
    store.ButtonBackgroundImage.BackgroundTransparency = 1
    store.ButtonBackgroundImage.Image = ""
    store.ButtonBackgroundImage.ImageTransparency = 0.18
    store.ButtonBackgroundImage.ScaleType = Enum.ScaleType.Crop
    store.ButtonBackgroundImage.Visible = true
    store.ButtonBackgroundImage.Parent = store.StealBar
    addCorner(store.ButtonBackgroundImage, 16)
    _AK._StealBarButtonImage = store.ButtonBackgroundImage
...
;(function()
    ...
    -- ============================================================
    -- BUTTON BACKGROUND IMAGE SELECTOR (HORIZONTAL SWIPE)
    -- ============================================================
    do
        ...
        local function applyButtonBackground(index)
            ...
            -- STEAL BAR also uses the selected BUTTON BACKGROUND IMAGE.
            if _AK._StealBarButtonImage and _AK._StealBarButtonImage.Parent then
                _AK._StealBarButtonImage.Image = image
                _AK._StealBarButtonImage.ImageTransparency = 0.18
                _AK._StealBarButtonImage.Visible = true
            end
        ...
        -- Horizontal swipe strip: no < > buttons.
        local scroll = Instance.new("ScrollingFrame")
        scroll.Name = "ButtonBackgroundSwipe"
        scroll.Size = UDim2.new(1, -20, 0, 86)
        scroll.Position = UDim2.new(0, 10, 0, 49)
        ...
        local function refresh()
            sub.Text = string.format(
                "SELECTED IMAGE %d / %d  •  SWIPE TO BROWSE • TAP TO APPLY",
        ...
        for i, imageId in ipairs(BUTTON_BG_IMAGES) do
            ...
            label.Size = UDim2.new(0, 25, 0, 18)
...
-- ============================================================
-- BACKGROUND IMAGE SELECTOR (HORIZONTAL SWIPE)
-- ============================================================
do
    local BG_IMAGES = {
        "rbxassetid://127008542588565",
